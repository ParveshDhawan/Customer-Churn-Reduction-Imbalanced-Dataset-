...
train_Original = read.csv('C:/Users/parve/Documents/Data_Science_Project/Data/Train_data.csv',header = T,na.strings = c(""," ","NA"))
test_Original = read.csv('C:/Users/parve/Documents/Data_Science_Project/Data/Test_data.csv',header = T,na.strings = c(""," ","NA"))
